...
import client.GUI.Forms.ViewPreordersController;
...
public class PreorderCell extends ListCell<PreOrder>{
    ...
    ViewPreordersController _parent;

    public PreorderCell(ViewPreordersController parent)
    {
        _parent = parent;
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("PreorderCell.fxml"));
